...
struct Tile
{
    ...
    bool victory;     // indica se o tile é de vitória ou não
};
...
public:
    ...
    void setTile(int col, int row, unsigned char tile, bool collidable = false, bool breakable = false, bool gameOver = false, bool victory = false)
    {
        ...
        this->map[col + row * this->width].victory = victory;
    }
    ...
    bool isVictoryTile(int col, int row)
    {
        return this->map[col + row * this->width].victory;
    }

    void setVictoryTile(int col, int row, bool victory)
    {
        this->map[col + row * this->width].victory = victory;
    }
